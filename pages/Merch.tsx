...
export default function Merch() {
  ...
  return (
    <div className="">
      ...
      <section className="items relative grid grid-cols-2 place-content-center md:grid-cols-3 gap-2 my-20 w-10/12 mx-auto">
      <Link href='/Cart' className="absolute -top-8  -right-20"><span className="absolute text-sm right-0 -top-2 bg-red-400 text-center text-white w-5 h-5 rounded-full  ">{length}</span><svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
